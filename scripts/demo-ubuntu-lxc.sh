...
VAPID_SUBJECT="${VAPID_SUBJECT:-mailto:admin@delicias-lia-demo.local}"
...
NEXT_PUBLIC_TUNNEL_URL="${NEXT_PUBLIC_TUNNEL_URL:-${TUNNEL_URL:-}}"
NEXT_PUBLIC_BASE_URL="${NEXT_PUBLIC_BASE_URL:-${TUNNEL_URL:-http://localhost:${PORT}}}"
NEXT_PUBLIC_VAPID_PUBLIC_KEY="${VAPID_PUBLIC_KEY}"
VAPID_PUBLIC_KEY="${VAPID_PUBLIC_KEY}"
VAPID_PRIVATE_KEY="${VAPID_PRIVATE_KEY}"
VAPID_SUBJECT="${VAPID_SUBJECT}"
N8N_API_KEY="${N8N_API_KEY:-$(openssl rand -hex 32)}"
ENV
